// // main/tracker.ts
// import { Story, Chapter } from './library'; // Or import from renderer if you prefer
// //import puppeteer from "puppeteer";
// import { JSDOM } from 'jsdom';

// export async function checkStoryUpdateNew(story: Story): Promise<Chapter[]> {
//     // if (story.title.includes("Shadow Slave")) {
...
// export async function baseRequest(url: string): Promise<string> {
...
//     // await page.goto('https://ranobes.net/chapters/1205249/', {
